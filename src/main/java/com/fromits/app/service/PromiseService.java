...
public class PromiseService implements HanaService<Integer, PromiseDto> {
  ...
  public void updateMeeting(Map<String, Object> updateResult) throws Exception {
    promiseRepository.updateMeeting(updateResult);
  }

  public void deleteMeeting(Integer proId) throws Exception {
    promiseRepository.deleteMeeting(proId);
  }
}
